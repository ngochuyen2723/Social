...
//        lvUser = (ListView) findViewById(R.id.list_user_str);
...
//                        listEmail.add(modelUser.getEmail());
                    }
                }
                // setup adapter
...
//                arrayAdapter = new ArrayAdapter<String>(getBaseContext(), android.R.layout.simple_list_item_1, listEmail);
//                lvUser.setAdapter(arrayAdapter);
//
//
//                adapterUsers = new AdapterUsers(getBaseContext(), userList);
//                adapterUsers.notifyDataSetChanged();
//                // set adapter to recycler view
//                userRv.setAdapter(adapterUsers);
                            ...
                            .addValueEventListener(new ValueEventListener() {
                                ...
                                public void onDataChange(@NonNull DataSnapshot snapshot) {
                                    if (snapshot.exists()) {
                                        ...
                                        /*con den day la lay danh sach user
                                         * debug thu, la no lay duoc list user as*/
                                        getAllUsers();
                                    }
                                }

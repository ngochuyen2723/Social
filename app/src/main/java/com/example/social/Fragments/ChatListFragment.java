...
import com.example.social.Adapters.AdapterChatList;
import com.example.social.Models.ModelChat;
import com.example.social.Models.ModelChatList;
...
public class ChatListFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        setHasOptionsMenu(true);    // to show menu option in frament
                ...
                for (DataSnapshot ds : snapshot.getChildren()) {
                    ...
                    if (chat.getReceiver().equals(currentUser.getUid()) &&
                        ...
                        if (!chat.getType().equals("text")){
                            theLastMessage = "Sent a "+chat.getType();
                        } else{
